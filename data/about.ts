...
export const ABOUT_EN: AboutType = {
    ...
    desc: "I like to code things from scratch as much as using React or Next. I also have skills in graphic techniques since I spent more than 10 years in the VFX field (compositing and motion design) for TV series and long feature films.",
    technologies: [
        "Languages : TypeScript / JavaScript, HTML, CSS, Less, MySQL, Pug, Twig",
...
export const ABOUT_FR: AboutType = {
    ...
    desc: "J'aime coder sans framework tout autant qu'avec React et Next. Après 10 années passées dans les effets spéciaux numériques pour le cinéma, j'ai aussi de bonnes compétences graphiques (compositing et motion design).",
    technologies: [
