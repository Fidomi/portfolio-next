...
export const PROJECTS_FR: Project[] = [
    ...
    },
    {
        ...
        desc: [
            ...
            "Elle m'a commandé un site vitrine pour présenter son activité d'évaluatrice et de formatrice.",
            "Elle a aussi besoin d'un outil pour automatiser la création des dossiers de toxicité de ses clients qui requiert une base de données complexe en cours de fabrication.",
        ],
        name: "clairenou",
        img: [clairenou_C],
        imgC: [
